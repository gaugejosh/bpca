		...
		<main id="main" class="site-main" role="main">
			...
			<div class="building-header-area">
				...
				<div class="building-filter-area">
                    ...
                    <span class="apts <?php if (array_search('apartments', $catarray) !== false || array_search('apt-green', $catarray) !== false)
                    {
	                    echo 'checked';
                    } ?>">
                    <input type="checkbox" id="rental-check" name="cat[]" value="apartments"
	                    <?php if (array_search('apartments', $catarray) !== false || array_search('apt-green', $catarray) !== false)
	                    {
		                    echo 'checked';
	                    } ?>
	                    />
                          ...
                          <?php if (array_search('apartments', $catarray) === false && array_search('apt-green', $catarray) === false)
                    {
	                    echo 'disabled';
                           ...
                           <?php if (array_search('apt-green', $catarray) !== false)
                    {
	                    echo 'checked';
                    } ?>
                          ">
                    <input type="checkbox" id="apt-green-check" name="cat[]" value="apt-green"
	                    ...
	                    />
								...
								<div class="styled-checks colored">
                                    ...
                                    <?php
										if (array_search('apartments', $catarray) === false && array_search('apt-green', $catarray) === false)
										{
											echo ' leed';
										}
										?>
							...
							<div class="cat-wrapper" id="buildings">
								<div class="checker big">
                    <span class="condo <?php if (array_search('condos', $catarray) !== false || array_search('condo-green', $catarray) !== false)
                    {
	                    echo 'checked';
                    } ?>">
                    <input type="checkbox" id="condo-check" name="cat[]" value="condos"
	                    <?php if (array_search('condos', $catarray) !== false || array_search('condo-green', $catarray) !== false)
	                    {
		                    echo 'checked';
	                    } ?>
	                    />
                          ...
                          <?php if (array_search('condos', $catarray) === false && array_search('condo-green', $catarray) === false)
                    {
	                    echo 'disabled';
                           ...
                           <?php if (array_search('condo-green', $catarray) !== false)
                    {
	                    echo 'checked';
                    } ?>
                          ">
